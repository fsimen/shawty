...
-- import qualified Database.Redis.Types as RR
...
existURI:: R.Connection
         -> BC.ByteString
         -> IO (Either R.Reply Bool)
existURI conn shortURI =   R.runRedis conn $ R.exists shortURI
  ...
  get "/:short" $ do
    ...
    case uri of
      ...
      Right mbBS -> case mbBS of
        Nothing -> text $ TL.pack $ "uri not found" ++ (show short)
